...
import { ArrowRightIcon, EllipsisIcon, SendIcon } from "@yz13/ui/icons";
...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full py-4 z-10 sticky top-0 px-6">
        <header
          className={cn(
        ...
        >
          ...
          <nav className="pr-6 flex [&>button]:text-base items-center gap-3">
            <div className="md:flex hidden [&>button]:text-base items-center gap-1">
              <Button variant="link" className="">Проекты</Button>
      ...
      <main
        className={cn(
          "max-w-7xl w-full mx-auto h-fit pt-[7.5%] pb-[12.5%] px-6",
      ...
      >
        <div className="w-full space-y-6">
          <LogoStack />
          <div className="py-8 *:block space-y-6 max-w-4xl w-fit mx-auto">
      ...
      <div className="w-full px-6 py-6 space-y-6">
        <div className="grid container mx-auto xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-muted-foreground uppercase">Проект</span>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="rounded-md h-16 aspect-video bg-secondary" />
        ...
        <div
          className={cn(
            "w-full h-fit container md:aspect-video aspect-auto border rounded-4xl mx-auto",
            "grid md:grid-cols-3 grid-cols-1 md:grid-rows-1 grid-rows-3",
        ...
        >
          ...
          <div className="size-full space-y-6">
            ...
            <div className="pb-6 px-6 w-full h-[calc(100%-96px)]">
              <div className="size-full gap-6 flex items-center md:justify-center justify-start overflow-hidden relative">
      ...
      <div className="w-full divide-y border-y *:[&>div]:px-6">
        <section className="py-4 hover:bg-card transition-colors">
          <div className="max-w-6xl mx-auto gap-3 grid md:grid-cols-2 grid-cols-1">
      ...
      <div className="w-full *:px-6 pb-6">
        ...
        <div className="grid max-w-6xl md:gap-6 gap-0 mx-auto md:grid-cols-2 grid-cols-1 md:divide-y-0 divide-y">
      ...
      <footer className="max-w-6xl py-12 mx-auto px-6 w-full">
      ...
      <div className="py-4 px-6 max-w-6xl flex items-center justify-between mx-auto w-full">
